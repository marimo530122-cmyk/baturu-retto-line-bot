...
4. 警告と一緒に、**AIに代わる前に相手に言う「つなぎの一言」**を大きく表示する(例:「ちょっと電話が遠いみたいなので、代わりの者がお話を伺いますね。」)。
5. ボタンを押すと、AIが「代わりの者です」と名乗って、端末のスピーカーから相手に返事をして時間を稼ぐ(`/api/decoy`)。「自分の応対に戻す」でいつでも戻せる。
...
- つなぎの一言は「代わりの者」という言い方にそろえ、「子どもに代わる」「孫に代わる」のように特定の家族を名乗る言い方はしない。
  誤検知で相手が本物の家族や正当な相手だったときにも角が立たず、AIが家族のふりをして話が食い違うこともないため。決まった文から選ぶだけなので待ち時間もない。
...
// レスポンス
{
  ...
  "bridge_excuse_ja": "ちょっと電話が遠いみたいなので、代わりの者がお話を伺いますね。",
